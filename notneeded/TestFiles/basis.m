...
%               If the basis is 'bspline' or 'nspline', the values are
%                 interior points at which the piecewise polynomials join.
%                 Note: In the case of B-splines the number of basis
%                 functions NBASIS is equal to the order of the spline
%                 functions plus the number of interior knots, that is the
%                 length of PARAMS. 
%                 In the case of N-splines the number of basis
%                 functions NBASIS is equal to the order of the spline
%                 functions plus the number of interior knots minus 2, that
%                 is the length of PARAMS. 
%               This means that NBASIS must be at least 1 larger than the
%                 length of PARAMS in the case of B-splines and at the most
%                 1 lower than the length of PARAMS in the case of
%                 N-splines.
